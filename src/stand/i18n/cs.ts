export default {
  ...
  'stand.profile.hint': 'Tyto údaje slouží pro váš profil doručení a doplní se jako příjemce do každého formuláře. Nemusíte uvádět skutečné. Údaje nebudou použity mimo tento test.',
  ...
  'task.saved': 'Už jste tu dříve objednávali. Tentokrát si chcete objednávku vyzvednout sami — vyberte libovolné výdejní místo ve městě {city}.',
  'task.city': 'Praha',
